...
@Service
public class ServiceModuleGenerator extends BaseGenerateService implements CommonModuleGenerate {

    Logger logger = LoggerFactory.getLogger(BeanModuleGenerator.class);

    private static final String MODULE_SUFFIX = "service";

    public ServiceModuleGenerator(ResourceLoader resourceLoader) {
